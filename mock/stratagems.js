export default [
  {
    name: 'Carisma',
    merits: 1,
    effect: `Essa Estratagema geralmente é observada em grandes líderes, comandantes e generais. 
    Torna o indivíduo em um marco, uma pessoa que mantém seus aliados unidos sob sua mera presença, 
    e os inspira a avançar e lutar.<br />
  ...
  },
  {
    name: 'Instinto',
    merits: 1,
    effect: `Essa Estratagema vem de instintos naturais de combate. Quando eles são despertados, 
      o herói irá ficar ainda mais alerta à situação presente, e será ainda mais difícil um ataque 
      alcançar seu corpo.
      Enquanto essa Estratagema estiver em efeito, você pode rerolar <strong>1 vez</strong> 
  ...
  },
  {
    name: 'Bravura',
    merits: 1,
    effect: `Essa Estratagema é a marca de guerreiros corajosos que não temem a morte ou o desafio e 
    lutam com todas as forças, transformando sua coragem em 
    um aumento de poder, mesmo que por apenas pouco tempo.<br />
    Enquanto essa Estratagema estiver em jogo, aumente o <strong>Valor Inicial</strong> de todas as 
    suas <i>Manobras Ofensivas</i> em <strong>+5</strong>.<br /> 
  ...
  },
  {
    ...
    merits: 1,
    effect: `Habilidade que demonstra a generosidade de um grande líder, que compartilha de 
    toda a sua sorte e progresso com seus súditos.<br />
  ...
  },
  {
    name: 'Regra de Ouro',
    merits: 1,
    effect: `Habilidade que pertence a heróis que acumularam grandes fortunas, que eram donos de 
    grandes tesouros monetários, ou que simplesmente tinham uma imensa riqueza; 
  ...
  },
  {
    name: 'Corpo Natural',
    merits: 1,
    effect: `Essa Estratagema é observada em heróis de grande beleza, donos de corpos acima da média, 
    que são exemplos de saúde, ou que possuem uma fisiologia particularmente resistente.<br />
  ...
  },
  {
    name: 'Olhos da Mente',
    merits: 1,
    effect: `É uma habilidade fruto de um rigoroso treinamento, em que o herói se especializou 
    em uma única forma de evitar os ataques de seus inimigos. Ele se tornou tão eficiente 
    em executá-la, que seu corpo parece se mover por conta própria.<br />
    Depois que ativar essa Estratagema, aumente o <strong>Valor Inicial</strong> da sua 
    próxima <i>Manobra Evasiva</i> em <strong>+5</strong>.<br />
  ...
  {
    name: 'Proteção Contra Flechas',
    merits: 1,
    effect: `Essa Estratagema se refere a uma benção dada ao herói, ou a um extenso treinamento 
    contra esse tipo de ataque, que o permite evitar ataques de longo alcance. 
    Os próprios ventos se manifestarão e irão criar barreiras para 
    desviar projéteis que tentem atingi-lo.<br />
  ...
  },
  {
    ...
    merits: 1,
    effect: `Um herói que possui essa Estratagema é dono de reflexos aguçados, como os de um animal 
  ...
  {
    name: 'Fogo de Suporte',
    merits: 1,
    effect: `Essa habilidade é empregada por atiradores de elite, caçadores e guardas.<br />
    Eles são treinados para reagir a aberturas nas defesas dos inimigos e alvejá-los quando estão 
    mais vulneráveis.<br />
  ...
  },
  {
    ...
    merits: 1,
    effect: `Técnica dos desbravadores corajosos que se atrevem a ir para onde nenhum homem jamais foi. 
    Sua bravura os permite atacar sem temor. <br />
    Durante o efeito dessa Estratagema, o conjurador pode escolher até <strong>três</strong> inimigos diferentes e atacar 
  ...
  },
  {
    ...
    merits: 1,
    effect: `<i>Ele olha de volta</i><br /><br />
    
    <strong>Uma</strong> vez por combate, um inimigo a sua escolha, 
    que não esteja sob cobertura e no seu campo de visão é afetado por uma maldição psicológica, 
  ...
  },
  {
    name: 'Sabotagem',
    merits: 1,
    effect: `Entre seus muitos conhecimentos, você é uma lenda com fama de usar meios não ortodoxos 
    de atrapalhar seus adversários, com o uso de distrações e armadilhas.<br />
    Só pode ser usada assim que o combate <strong>começa</strong>; 
  ...
  },
  {
    ...
    merits: 1,
    effect: `Há sangue de um poderoso Phantasmal correndo nas suas veias, ou talvez você mesmo 
    seja um monstro da mitologia que tenha encarnado em forma humana. 
    De qualquer forma, você pode por um curto período de tempo, buscar uma força muito maior 
  ...
  },
  {
    name: 'Alma do Mártir',
    merits: 1,
    effect: `Técnica de heróis santos e de grande compaixão.
     Eles se sacrificam por seus irmãos mesmo no calor do combate, 
  ...
  },
  {
    ...
    merits: 1,
    effect: `Essa Estratagema é encontrada nos conhecimentos de comandantes e generais que 
    precisam planejar a marcha de suas tropas e que posição elas irão ocupar na zona de batalha, 
  ...
  },
  {
    ...
    effect: `Durante algumas rodadas, um herói que seja um conhecido conselheiro de guerra pode aumentar as capacidades de um dos seus aliados,
      ...
      Quando usar essa Estratagema, escolha um aliado; enquanto essa Estratagema estiver ativa, aumente o dano de todas as Manobras Ofensivas desse aliado em <strong>+20</strong>.
  ...
  },
  {
    ...
    merits: 1,
    effect: `Essa Estratagema quebra as barreiras de uma classe em que o herói tenha sido 
    invocado e o devolve a habilidade de usar feitiços que ele tinha em vida, 
    mas provavelmente foi removida pelas limitações do sistema.<br />
    Quando adquirir essa Estratagema, você deve escolher um <strong>Elemento de Feitiços</strong>. 
  ...
  },
  {
    name: 'Conquistador',
    merits: 1,
    effect: `Como o nome sugere, é a Estratagema dos famosos heróis que marcharam por grandes distâncias 
    com seus exércitos, para terras distantes e exóticas, e tomaram tais terras para si.<br />
  ...
  },
  {
    name: 'Contra-Herói',
    merits: 1,
    effect: `Essa Estratagema geralmente é encontrada com aqueles que não são heróis conhecidos, 
    mas viveram ao lado deles e experimentaram grandes aventuras à sombra deles.<br />
    Isso confere um enorme conhecimento sobre como tal arquétipo opera, e com isso, formas de conter como eles combatem.<br />
    Quando essa Estratagema é colocada em jogo, <strong>qualquer</strong> Técnica Especial 
    que um inimigo use têm seu nível de perigo <strong>aumentado em 1</strong>.<br /> 
    Se uma Estratagema for usada por um inimigo, ela será considerada uma <strong>Técnica Especial</strong> 
  ...
  },
  {
    ...
    merits: 1,
    effect: `Essa Estratagema atrela um número de poder a história de um herói, podendo 
    ser uma hora do dia em que seu potencial alcança o pináculo, um dia em particular 
    do mês em que seus poderes surgem com mais potência ou a mera presença desse símbolo 
    importante para ele aumente suas capacidades.<br />
    Só pode ser usada assim que o combate <strong>começa</strong>; <strong>Escolha</strong> 
  ...
  },
  {
    name: 'Bruxaria',
    merits: 1,
    effect: `Você detém grande comando sobre suas habilidades mágicas e controla os 
