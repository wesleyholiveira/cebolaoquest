export default [
    ...
    },
    {
        ...
        Os clones podem se mover independentemente do conjurador, embora inicialmente tenham seus turnos obrigatoriamente colocados logo após o turno do original.
        Eles podem usar a opção Esperar, para agir em outros turnos, como por exemplo logo após um aliado, ou antes do conjurador, na rodada seguinte.<br /><br />
        
        Eles não podem usar Estratagemas, e os Fantasmas Nobres que possuem são meras ilusões também, e <strong>NÃO</strong> conferem nenhum bônus.<br /><br />
        
        Enquanto os clones estão presentes, inimigos devem testar para atingir o original com qualquer ataque que não atinja múltiplos alvos,
        sendo que o original sempre tem uma chance reduzida de ser atingido em comparação aos seus clones.<br />
        Atingir um clone irá fazer ele desaparecer, mas atingir o original irá fazer todos os clones desaparecerem de uma vez.<br /><br />
        
        Os oponentes irão tender a tentar se defender das cópias como se fossem o original;
        um oponente irá tentar aparar o ataque de um clone com sua arma e não irá conseguir usar a manobra esquivar se estiver sendo atacado por dois clones que estejam a distância de um golpe corpo-a-corpo. 
        Ilusões que atacam desaparecem, porém.
        `
    },
    {
        ...
        Enquanto permanecer transformado, <strong>NENHUM</strong> dos seus <strong>Fantasmas Nobres: "Armamentos Lendários"</strong> podem ser usados e você perderá qualquer benefício que eles lhe conferem.<br /><br />
    ...
    },
    {
        ...
        A partir do turno em que esse Reality Marble é ativado, o conjurador não mais precisa gastar <strong>Pontos de Energia</strong> para usar <strong>Técnicas Especiais</strong> ou <strong>Feitiços</strong>.<br /><br />
        
        Suas Estratagemas <strong>perdem</strong> duração, se tornando <strong>permanentes</strong> enquanto o Reality Marble estiver o cercando. Ele ganha o direito de <strong>empilhar</strong> Estratagemas,
        mas fica limitado a ativar <strong>UMA</strong> por turno.<br /><br />
        
        <i>Seu corpo e sua mente se tornam blindados contra efeitos negativos.</i><br /><br />
        
        <i>Todas as suas Manobras Evasivas podem ser executadas sem restrições.</i><br /><br />
        
        <i>Inimigos não ganham nenhum bônus por Descoberta de Nome Verdadeiro enquanto estiverem dentro do Reality Marble.</i>
        `
    },
    {
        name: 'Desolação',
    ...
    },
    {
        ...
        A partir do turno em que esse Reality Marble é ativado, o conjurador se torna <strong>intangível</strong>;
        inimigos não conseguem saber sua posição, <strong>ele não pode receber dano e mesmo ataques que afetam múltiplos alvos não o alcançam</strong>.<br /><br />
        
        Sua ação de movimento se torna <strong>irrestrita</strong>; isso quer dizer que você pode atacar qualquer inimigo dentro do Reality Marble,
    ...
    },
    {
        ...
        nesse caso, o conjurador não recebe o dano diretamente, no lugar, ele deve rolar um dado de acordo com o seu rank no parâmetro Fantasma Nobre:
        <strong>"1d20/1d12/1d6"</strong> para "<strong>D-C / B-A / S</strong>". O dano de cada ataque passa a ser o valor rolado nesse dado.<br />
        <strong>Note que: golpes críticos dos inimigos ignoram esse efeito.</strong>
        `
    },
].sort((a, b) => {
